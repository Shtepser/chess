...
@pytest.mark.parametrize("position,another_pieces,possible_moves", [
    ...
    ("A1",
     [(Rook, Colour.WHITE, "D4"),
      (King, Colour.WHITE, "D5"), (King, Colour.BLACK, "D7")],
     {"B2", "C3"}),
    ("E4",
     [(Pawn, Colour.WHITE, "C2"),
      (King, Colour.WHITE, "E3"), (King, Colour.BLACK, "E1")],
...
@pytest.mark.parametrize("position,another_pieces,possible_moves", [
    ("A1",
     [(King, Colour.WHITE, "H7"), (King, Colour.BLACK, "H5")],
     {"C2", "B3"}),
    ("F8",
     [(King, Colour.WHITE, "A1"), (King, Colour.BLACK, "H5")],
     {"D7", "E6", "G6", "H7"}),
    ("D5",
     [(King, Colour.WHITE, "H7"), (King, Colour.BLACK, "H5")],
...
@pytest.mark.parametrize("position,another_pieces,possible_moves", [
    ...
    ("E4",
     [(Pawn, Colour.WHITE, "E3"), (Rook, Colour.WHITE, "C4"),
      (Pawn, Colour.WHITE, "C2"),
      (King, Colour.WHITE, "D6"), (King, Colour.BLACK, "D8")],
...
@pytest.mark.parametrize("position,another_pieces,possible_moves", [
    ("A1",
     [(King, Colour.WHITE, "H8"), (King, Colour.BLACK, "H6")],
     {"A2", "A3", "A4", "A5", "A6", "A7", "A8",
      "B1", "C1", "D1", "E1", "F1", "G1", "H1"}),
    ("A1",
